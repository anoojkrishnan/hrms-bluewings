export const ErrorCodes = {
  ...
  AUTHORITY_SIGNATURE_NOT_FOUND: 'AUTHORITY_SIGNATURE_NOT_FOUND',
  AUTHORITY_SIGNATURE_DUPLICATE: 'AUTHORITY_SIGNATURE_DUPLICATE',
  ...
  PAYROLL_RUN_INVALID_TRANSITION: 'PAYROLL_RUN_INVALID_TRANSITION',
  PAYROLL_COMPONENT_NOT_FOUND: 'PAYROLL_COMPONENT_NOT_FOUND',
  PAYROLL_STRUCTURE_NOT_FOUND: 'PAYROLL_STRUCTURE_NOT_FOUND',
  PAYROLL_CYCLE_NOT_FOUND: 'PAYROLL_CYCLE_NOT_FOUND',
  PAYROLL_EMPLOYEE_NO_SALARY: 'PAYROLL_EMPLOYEE_NO_SALARY',
  PAYROLL_FORMULA_ERROR: 'PAYROLL_FORMULA_ERROR',
  PAYROLL_DUPLICATE_RUN: 'PAYROLL_DUPLICATE_RUN',
  PAYROLL_PAYSLIP_NOT_FOUND: 'PAYROLL_PAYSLIP_NOT_FOUND',
  PAYROLL_ALREADY_PROCESSING: 'PAYROLL_ALREADY_PROCESSING',
